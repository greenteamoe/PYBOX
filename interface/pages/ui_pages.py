...
################################################################################
## Form generated from reading UI file 'pagesfUFuYI.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(813, 561)
        self.page_1 = QWidget()
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label_3.setText(QCoreApplication.translate("application_pages", u"Page 1", None))
        self.label_2.setText(QCoreApplication.translate("application_pages", u"Page 2", None))
        self.label.setText(QCoreApplication.translate("application_pages", u"Page 3", None))
    # retranslateUi
